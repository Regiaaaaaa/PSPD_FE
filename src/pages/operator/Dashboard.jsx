  ...
  return (
    <AppLayout>
      ...
      <div className="p-3 sm:p-4 lg:p-6 max-w-5xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Dashboard Operator</h1>
          <p className="text-sm text-gray-600 mt-1">Pantau aktivitas peminjaman dan denda bulanan</p>
        </div>
