        ...
        {data && (
          <>
            ...
            <div className="kpi-grid">
              <KpiCard label="Total Aktivitas"      value={data.total_transaksimu}    sub="bulan ini"       accentColor="#378ADD" delay={0}   />
            ...
            {/* Denda berjalan */}
            {data.denda_berjalan > 0 && (
              <div style={{
                display: "flex", alignItems: "center", justifyContent: "space-between",
                background: "#FAECE7", border: "0.5px solid #F5C4B3",
                borderRadius: 12, padding: "12px 16px", marginBottom: 12,
                animation: "fadeUp 0.35s ease both", animationDelay: "220ms",
              }}>
                <div>
                  <div style={{ fontSize: 12, fontWeight: 500, color: "#993C1D", textTransform: "uppercase", letterSpacing: "0.4px" }}>
                    Denda berjalan
                  </div>
                  <div style={{ fontSize: 11, color: "#D85A30", marginTop: 2 }}>
                    Akumulasi keterlambatan saat ini
                  </div>
                </div>
                <span style={{ fontSize: 20, fontWeight: 500, color: "#993C1D" }}>
